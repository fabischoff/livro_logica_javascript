...
function exibirMoedas() {
    ...
    var alt0_20 = "Moedas de Vinte centavos";
    ...
    criarMoedas(num0_25, divMoedas, "0_25.jpg", alt0_20, "moeda0_25");
...
function conferirSoma() {
    ...
    for (var i = 0; i < moedas.length; i++) {
        if (moedas[i].className == "moeda1_00") {
            totalMoedas += 1;
        } else if (moedas[i].className == "moeda1_00") {
            totalMoedas += 1;
    ...
    if (soma == totalMoedas.toFixed(2)) {
        ...
        var mensagem = "Ops.. Você errou! Resposta certa: " + totalMoedas.toFixed(2);
    }
